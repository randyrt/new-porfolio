            ...
            <div v-if="showCaseStudy && caseStudy" ref="caseStudyAnchor"
                ...
                <div
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <span
                            class="text-white/80 text-sm font-mono tracking-[0.15em] border-l border-white/20 pl-3 uppercase">
                            {{ t('projects.case_study') }}
                        </span>
                    </div>
                    <span class="text-white/70 text-sm font-mono truncate max-w-[200px] tracking-wide">
                        {{ title }}
                    </span>
                </div>
                    ...
                    <div class="grid gap-5 lg:grid-cols-2">
                        ...
                        <div
                            ...
                            <div class="flex items-center justify-center gap-2.5 mb-3">
                                ...
                                <p class="text-sm font-bold uppercase tracking-[0.2em] text-emerald-600/90">{{
                        ...
                        <div
                            ...
                            <div class="flex items-center justify-center gap-2.5 mb-3">
                                ...
                                <p class="text-sm font-bold uppercase tracking-[0.2em] text-pink-600/90">{{
...
const formattedDescription = computed(() => {
    ...
    if (props.productionUrl) {
        const linkText = t('projects.view_in_production');
        result += `<br> <a href="${props.productionUrl}" target="_blank" rel="noopener noreferrer" class="inline-flex !mt-4 !items-center gap-2 px-4 py-2 bg-purple-700 hover:bg-violet-500 !text-white font-semibold rounded-lg shadow-sm hover:shadow-md transition-all duration-200 !no-underline">
        <span>${linkText}</span>
