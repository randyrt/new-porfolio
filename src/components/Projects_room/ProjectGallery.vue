...
const formattedDescription = computed(() => {
    ...
    if (props.productionUrl) {
        ...
        result += ` <a href="${props.productionUrl}" target="_blank" rel="noopener noreferrer" class="inline-flex !mt-4 !items-center gap-2 px-4 py-2 bg-purple-700 hover:bg-violet-500 !text-white font-semibold rounded-lg shadow-sm hover:shadow-md transition-all duration-200 !no-underline">
        <span>${linkText}</span>
