  ...
  <div class="flex flex-col md:flex-row h-screen overflow-hidden">
    ...
    <Transition name="sidebar-slide">
      <aside v-if="sidebarVisible"
        class="hidden md:flex w-68 shadow-lg flex-col bg-gradient from-var(--app-primary) to-sky-50 transition-all duration-300 px-1 mt-0 h-full border-r border-gray-200">
