...
if (__VLS_ctx.loading) {
    ...
    __VLS_asFunctionalElement(__VLS_elements.div, __VLS_elements.div)({
        ...{ class: "terminal-container mb-10 w-1/2 mx-auto" },
        'data-aos': "fade-up",
    });
    __VLS_asFunctionalElement(__VLS_elements.div, __VLS_elements.div)({
        ...{ class: "terminal bg-gray-900 dark:bg-black rounded-lg shadow-xl overflow-hidden border border-gray-700" },
    });
    __VLS_asFunctionalElement(__VLS_elements.div, __VLS_elements.div)({
        ...{ class: "terminal-header bg-gray-800 dark:bg-gray-900 px-4 py-2 flex items-center gap-2" },
    });
    __VLS_asFunctionalElement(__VLS_elements.div, __VLS_elements.div)({
    ...
    __VLS_asFunctionalElement(__VLS_elements.div, __VLS_elements.div)({
        ...{ class: "terminal-body p-4 font-mono text-sm" },
    });
    for (const [line, index] of __VLS_getVForSourceType((__VLS_ctx.visibleLines))) {
        // @ts-ignore
        [visibleLines,];
        __VLS_asFunctionalElement(__VLS_elements.div, __VLS_elements.div)({
            key: (index),
    ...
    if (!__VLS_ctx.isComplete) {
        ...
        [isComplete,];
        __VLS_asFunctionalElement(__VLS_elements.div, __VLS_elements.div)({
            ...{ class: "typing-cursor inline-block w-2 h-4 bg-green-400" },
        });
    }
